        ...
        <div class="row ">
          <!-- Box Menu kiri -->
              <div class="col-lg-2 bg-body-tertiary shadow   " style="height: 730px;">
                ...
                <li> <a href="rekap.php"><button class="btn mt-3 w-100 text-start"><i class="bi bi-person-circle  me-3"></i> Daftar Penjualan</button></li></a> 
                </ul>
              </div>
          <!--  -->
          ...
          <div class="text-center " style="padding-top: 3rem;">
            <h3><i class="fa-solid fa-cart-shopping me-3 mb-2"></i>Daftar Pesanan Penjualan</h3>
          </div>
          
        <!-- Awal Card -->
          <div class="card ">
            <div class="card-header bg-primary text-light">
            <i class="fa-solid fa-user"></i>  Data Pembeli
            </div>
            <div class="card-body">
              <a href="tambah.php?"> <button class="btn btn-success mb-3" ><i class="fa-solid fa-user-plus me-2"></i>Tambah Daftar</button></a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content text-dark">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Data Pembeli</h1>
